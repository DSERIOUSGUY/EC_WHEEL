...
class Wheelchair(Robot):
    ...
    def __init__(self):
        ...
        self.sensors = tuple( self.getDevice(sensor) for sensor in  [
            "Sharp's IR sensor GP2Y0A710K0F FrontLeft",
            "Sharp's IR sensor GP2Y0A710K0F FrontRight",
            "Sharp's IR sensor GP2Y0A710K0F Right",
            "Sharp's IR sensor GP2Y0A710K0F Back",
            "Sharp's IR sensor GP2Y0A710K0F Left"   ] )
