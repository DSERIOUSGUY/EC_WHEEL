...
=======
    TIME_STEP = 64
>>>>>>> 338fef1ecf487d2e06053b424a94a4d42a2f89eb
    WHEEL_VEL = 1.5
...
<<<<<<< HEAD
            "Sharp's IR sensor GP2Y0A02YK0F FrontLeft",
            "Sharp's IR sensor GP2Y0A02YK0F FrontRight",
            "Sharp's IR sensor GP2Y0A02YK0F Front",
            "Sharp's IR sensor GP2Y0A02YK0F Right",
            "Sharp's IR sensor GP2Y0A02YK0F Back",
            "Sharp's IR sensor GP2Y0A02YK0F Left",
            "Sharp's IR sensor GP2Y0A02YK0F LedgeDetector"   
=======
...
<<<<<<< HEAD
        #print("State change "+ str(lastClickState and leftClick == False))

        if lastClickState and leftClick == False:
            if cruiseControlFlag == True:
                cruiseControlFlag = False
                print("Cruise Control Disabled")
            elif cruiseControlFlag == False:
...
<<<<<<< HEAD
    ...
    def getLimits(self, target):
        global collisonSwitch

        if not collisonSwitch:
